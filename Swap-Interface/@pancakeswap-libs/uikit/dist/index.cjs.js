...
var Icon$F = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        React__default['default'].createElement("g", { clipPath: "url(#clip0)" },
            ...
            React__default['default'].createElement("path", { d: "M51.0823 29.9055C50.3505 27.1742 47.543 25.5533 44.8116 26.2851L17.6112 33.5735C14.8798 34.3053 13.2589 37.1128 13.9908 39.8441L18.546 56.8444C19.2778 59.5758 22.0853 61.1967 24.8167 60.4648L52.0171 53.1765C54.7485 52.4446 56.3694 49.6371 55.6375 46.9058L51.0823 29.9055Z", fill: "url(#paint0_linear)" }),
        ...
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("linearGradient", { id: "paint0_linear", x1: "31.2114", y1: "29.9293", x2: "38.4169", y2: "56.8207", gradientUnits: "userSpaceOnUse" },
            ...
            React__default['default'].createElement("linearGradient", { id: "paint1_linear", x1: "34.8059", y1: "15.6037", x2: "31.9071", y2: "26.4221", gradientUnits: "userSpaceOnUse" },
                React__default['default'].createElement("stop", { stopColor: "#53DEE9" }),
                React__default['default'].createElement("stop", { offset: "1", stopColor: "#1FC7D4" })),
            React__default['default'].createElement("clipPath", { id: "clip0" },
...
var ExpandableButton = function (_a) {
    ...
    return (React__default['default'].createElement(IconButton, { "aria-label": "Hide or show expandable content", onClick: onClick },
        children,
        expanded ? React__default['default'].createElement(Icon$18, { color: "invertedContrast" }) : React__default['default'].createElement(Icon$1b, { color: "invertedContrast" })));
};
...
var ExpandableLabel = function (_a) {
    var onClick = _a.onClick, expanded = _a.expanded, children = _a.children;
    return (React__default['default'].createElement(Button, { variant: "text", "aria-label": "Hide or show expandable content", onClick: onClick, endIcon: expanded ? React__default['default'].createElement(Icon$18, { color: "primary" }) : React__default['default'].createElement(Icon$1b, { color: "primary" }) }, children));
};
    ...
    return (React__default['default'].createElement(StyledAlert, null,
        ...
        onClick && (React__default['default'].createElement(CloseHandler, null,
            React__default['default'].createElement(IconButton, { scale: "sm", variant: "text", onClick: onClick },
                React__default['default'].createElement(Icon$17, { width: "24px", color: "currentColor" }))))));
};
...
var DefaultSeparator = React__default['default'].createElement(Icon$19, { color: "currentColor", width: "24px" });
...
var FallingBunnies = function (_a) {
    ...
    var bunnies = __spreadArray([], Array(count)).map(function (_, index) { return (React__default['default'].createElement(Bunny, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
        React__default['default'].createElement(Icon$Z, { width: size, height: size }))); });
...
var Progress = function (_a) {
    ...
    return (React__default['default'].createElement(StyledProgress, { variant: variant },
        showProgressBunny && (React__default['default'].createElement(ProgressBunnyWrapper, { style: { left: stepGuard(primaryStep) + "%" } },
            React__default['default'].createElement(Icon$H, null))),
...
var FloatingPanIcon = styled__default['default'](Icon$r)(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(Icon$Z, { className: "mobile-icon" }),
    ...
    if (!isPushed) {
        return (React__default['default'].createElement(Container, null,
            React__default['default'].createElement(IconButton, { variant: "text", onClick: function () { return pushNav(true); } },
                React__default['default'].createElement(Icon$16, null))));
    }
    return (React__default['default'].createElement(Container, null,
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(HelpLink, { href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true },
            React__default['default'].createElement(Icon$12, { color: "primary", mr: "6px" }),
...
var CopyToClipboard = function (_a) {
    ...
    return (React__default['default'].createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React__default['default'].createElement(Icon$14, { width: "20px", color: "primary", ml: "4px" }),
...
exports.ChevronRightIcon = Icon$19;
exports.ChevronUpIcon = Icon$18;
exports.CircleOutlineIcon = Icon$1e;
exports.CloseIcon = Icon$17;
exports.CogIcon = Icon$16;
exports.CommunityIcon = Icon$15;
exports.CopyIcon = Icon$14;
exports.CrownIcon = Icon$13;
...
exports.HelpIcon = Icon$12;
exports.HistoryIcon = Icon$11;
exports.IconButton = IconButton;
exports.Image = Image;
exports.InfoIcon = Icon$1s;
exports.Input = Input$1;
exports.LaurelLeftIcon = Icon$10;
exports.LaurelRightIcon = Icon$$;
exports.Link = Link;
exports.LinkExternal = LinkExternal;
exports.ListViewIcon = Icon$_;
exports.LogoIcon = Icon$Z;
exports.LogoRoundIcon = Icon$Y;
exports.MedalBronzeIcon = Icon$X;
exports.MedalGoldIcon = Icon$W;
exports.MedalPurpleIcon = Icon$V;
exports.MedalSilverIcon = Icon$U;
exports.MedalTealIcon = Icon$T;
exports.Menu = Menu;
...
exports.PlayCircleOutlineIcon = Icon$L;
exports.PocketWatchIcon = Icon$M;
exports.PrizeIcon = Icon$K;
exports.Progress = Progress;
exports.ProgressBunny = Icon$H;
exports.Radio = Radio;
...
exports.TimerIcon = Icon$A;
exports.ToastContainer = ToastContainer;
exports.Toggle = Toggle;
exports.TrophyGoldIcon = Icon$z;
exports.VerifiedIcon = Icon$I;
exports.VolumeOffIcon = Icon$v;
exports.VolumeUpIcon = Icon$u;
exports.WaitIcon = Icon$G;
