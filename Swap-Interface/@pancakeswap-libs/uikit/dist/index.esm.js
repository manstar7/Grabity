...
var Icon$1n = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "" }, props),
...
var Icon$1i = function (props) {
    ...
    var secondaryColor = theme.isDark ? "#ccc" : "#bdc2c4";
...
var Icon$Z = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: '/images/left_img.png' })));
};
...
var Icon$N = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/logo_icon.png" })));
};
...
var Icon$F = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        React.createElement("g", { clipPath: "url(#clip0)" },
            ...
            React.createElement("path", { d: "M51.0823 29.9055C50.3505 27.1742 47.543 25.5533 44.8116 26.2851L17.6112 33.5735C14.8798 34.3053 13.2589 37.1128 13.9908 39.8441L18.546 56.8444C19.2778 59.5758 22.0853 61.1967 24.8167 60.4648L52.0171 53.1765C54.7485 52.4446 56.3694 49.6371 55.6375 46.9058L51.0823 29.9055Z", fill: "url(#paint0_linear)" }),
        ...
        React.createElement("defs", null,
            React.createElement("linearGradient", { id: "paint0_linear", x1: "31.2114", y1: "29.9293", x2: "38.4169", y2: "56.8207", gradientUnits: "userSpaceOnUse" },
                React.createElement("stop", { stopColor: "#53DEE9" }),
                React.createElement("stop", { offset: "1", stopColor: "#1FC7D4" })),
            React.createElement("linearGradient", { id: "paint1_linear", x1: "34.8059", y1: "15.6037", x2: "31.9071", y2: "26.4221", gradientUnits: "userSpaceOnUse" },
                React.createElement("stop", { stopColor: "#53DEE9" }),
                React.createElement("stop", { offset: "1", stopColor: "#1FC7D4" })),
            React.createElement("clipPath", { id: "clip0" },
...
var ExpandableButton = function (_a) {
    ...
    return (React.createElement(IconButton, { "aria-label": "Hide or show expandable content", onClick: onClick },
        children,
        expanded ? React.createElement(Icon$18, { color: "invertedContrast" }) : React.createElement(Icon$1b, { color: "invertedContrast" })));
};
...
var ExpandableLabel = function (_a) {
    var onClick = _a.onClick, expanded = _a.expanded, children = _a.children;
    return (React.createElement(Button, { variant: "text", "aria-label": "Hide or show expandable content", onClick: onClick, endIcon: expanded ? React.createElement(Icon$18, { color: "primary" }) : React.createElement(Icon$1b, { color: "primary" }) }, children));
};
    ...
    return (React.createElement(StyledAlert, null,
        ...
        onClick && (React.createElement(CloseHandler, null,
            React.createElement(IconButton, { scale: "sm", variant: "text", onClick: onClick },
                React.createElement(Icon$17, { width: "24px", color: "currentColor" }))))));
};
var templateObject_1$M, templateObject_2$j, templateObject_3$8, templateObject_4$6;
...
var DefaultSeparator = React.createElement(Icon$19, { color: "currentColor", width: "24px" });
...
var FallingBunnies = function (_a) {
    ...
    var bunnies = __spreadArray([], Array(count)).map(function (_, index) { return (React.createElement(Bunny, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
        React.createElement(Icon$Z, { width: size, height: size }))); });
...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(Link, __assign({ external: true }, props),
        children,
        React.createElement(Icon$P, { color: "primary", ml: "4px" })));
};
...
var Progress = function (_a) {
    ...
    return (React.createElement(StyledProgress, { variant: variant },
        showProgressBunny && (React.createElement(ProgressBunnyWrapper, { style: { left: stepGuard(primaryStep) + "%" } },
            React.createElement(Icon$H, null))),
...
var templateObject_1$o, templateObject_2$b, templateObject_3$7, templateObject_4$5, templateObject_5$3, templateObject_6, templateObject_7;
...
var SpinnerIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("image", { width: "96", height: "96", href: "/images/loader.png" })));
};
var Container$3 = styled.div(templateObject_3$5 || (templateObject_3$5 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
var RotatingPancakeIcon = styled(SpinnerIcon)(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
// var FloatingPanIcon = styled(Icon$r)(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var templateObject_1$m, templateObject_2$9, templateObject_3$5, templateObject_4$3, templateObject_5$1;
...
var Modal = function (_a) {
    var title = _a.title, onDismiss = _a.onDismiss, onBack = _a.onBack, children = _a.children, _b = _a.hideCloseButton, hideCloseButton = _b === void 0 ? false : _b, _c = _a.bodyPadding, bodyPadding = _c === void 0 ? "24px" : _c, _d = _a.headerBackground, headerBackground = _d === void 0 ? "transparent" : _d, _e = _a.minWidth, minWidth = _e === void 0 ? "360px" : _e, props = __rest(_a, ["title", "onDismiss", "onBack", "children", "hideCloseButton", "bodyPadding", "headerBackground", "minWidth"]);
...
var Icon$p = function (props) {
    return (
        React.createElement("img", {src:'/images/farm-ico.png', className:"icon_sidebar" })
    );
    // return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$o = function (props) {
    return (
        React.createElement("img", {src:'/images/team.png', className:"icon_sidebar" })
    );
    // return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
    //     React.createElement("path", { d: "M12 12.75C13.63 12.75 15.07 13.14 16.24 13.65C17.32 14.13 18 15.21 18 16.38V17C18 17.55 17.55 18 17 18H7C6.45 18 6 17.55 6 17V16.39C6 15.21 6.68 14.13 7.76 13.66C8.93 13.14 10.37 12.75 12 12.75ZM4 13C5.1 13 6 12.1 6 11C6 9.9 5.1 9 4 9C2.9 9 2 9.9 2 11C2 12.1 2.9 13 4 13ZM5.13 14.1C4.76 14.04 4.39 14 4 14C3.01 14 2.07 14.21 1.22 14.58C0.48 14.9 0 15.62 0 16.43V17C0 17.55 0.45 18 1 18H4.5V16.39C4.5 15.56 4.73 14.78 5.13 14.1ZM20 13C21.1 13 22 12.1 22 11C22 9.9 21.1 9 20 9C18.9 9 18 9.9 18 11C18 12.1 18.9 13 20 13ZM24 16.43C24 15.62 23.52 14.9 22.78 14.58C21.93 14.21 20.99 14 20 14C19.61 14 19.24 14.04 18.87 14.1C19.27 14.78 19.5 15.56 19.5 16.39V18H23C23.55 18 24 17.55 24 17V16.43ZM12 6C13.66 6 15 7.34 15 9C15 10.66 13.66 12 12 12C10.34 12 9 10.66 9 9C9 7.34 10.34 6 12 6Z" })));
};
...
var Icon$l = function (props) {
    return (
        React.createElement("img", {src:'/images/home-ico.png', className:"icon_sidebar" })
    );
};

var Icon$TR = function (props) {
    return (
        React.createElement("img", {src:'/images/trade-ico.png', className:"icon_sidebar" })
    );
};
var Icon$DI= function (props) {
    return (
        React.createElement("img", {src:'/images/doc.png', className:"icon_sidebar" })
    );
};
var Icon$SI = function (props) {
    return (
        React.createElement("img", {src:'/images/grap.png', className:"icon_sidebar" })
    );
};
var Icon$AP = function (props) {
    return (
        React.createElement("img", {src:'/images/add_pool.png', className:"icon_sidebar" })
    );
};
...
var Icon$j = function (props) {
    return (
        React.createElement("img", {src:'/images/info.png', className:"icon_sidebar" })
    );
    // return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
    //     React.createElement("path", { d: "M5 7C5 6.44772 4.55228 6 4 6C3.44772 6 3 6.44772 3 7V18C3 19.1046 3.89543 20 5 20H20C20.5523 20 21 19.5523 21 19C21 18.4477 20.5523 18 20 18H5V7Z" }),
    //     React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M19 17H7C6.44772 17 6 16.5523 6 16V12C6 11.4477 6.44772 11 7 11H10V10C10 9.44772 10.4477 9 11 9H14V7C14 6.44772 14.4477 6 15 6H19C19.5523 6 20 6.44772 20 7V16C20 16.5523 19.5523 17 19 17ZM16 8H18V15H16V8ZM12 15H14V11H12V15ZM10 13H8V15H10V13Z" })));
...
var Logo$2 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 190 43" }, props),
        React.createElement("image", { width: "125", height: "43", href: isDark ? '/images/logo-icon-swapp.png' : '/images/logo-icon-black.png' })))
};
...
var Icon$g = function (props) {
    return (
        React.createElement("img", {src:'/images/more.png', className:"icon_sidebar" })
    );
    // return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$e = function (props) {
    return (
        React.createElement("img", {src:'/images/pool.png', className:"icon_sidebar" })
    );
    // return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$WP = function (props) {
    return (
        React.createElement("img", {src:'/images/warp-icon.png', className:"icon_sidebar" })
    );
};

var Icon$SSP = function (props) {
    return (
        React.createElement("img", {src:'/images/stakeswap-icon.png', className:"icon_sidebar" })
    );
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement(Icon$Z, { className: "mobile-icon" }),
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "Orangeswap home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "Pancake home page" }, innerLogo))));
};
...
var links = [
    ...
    // },
    {
        ...
        items: [
            ...
            {
                label: "Task Center",
                href: "http://localhost:3000/profile/tasks",
            },
            {
                label: "YourProfile",
...
var socials = [
    {
        label: "Github",
        icon: "GithubIcon",
        href: "https://github.com/grabityproject",
        // items: [
        //     {
        //         label: "English",
    ...
    },
    {
        label: "Medium",
        icon: "MediumIcon",
        href: "https://medium.com/grabityorg",
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/Grabityorg",
    },
];
var MENU_HEIGHT = 64;
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { onClick: handleClick, className: className, isActive: isActive },
            ...
            isOpen ? React.createElement(Icon$1n, null) : React.createElement(Icon$1o, null)),
...
var MenuLink = function (_a) {
    ...
    {
        isHttpLink = href.startsWith("mailto");
    }
    ...
    return (React.createElement(Container$1, null, links.map(function (entry) {
        ...
        if (entry.items) {
            ...
            return (React.createElement(Accordion$1, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }) }, isPushed &&
                entry.items.map(function (item) { return (React.createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === window.location.href, onClick: handleClick },
        ...
        return (React.createElement(MenuEntry, { key: entry.label, isActive: entry.href === window.location.href, className: calloutClass },
...
var SocialLinks = function () { return (React.createElement(Flex, null, socials.map(function (social, index) {
    ...
    var iconProps = { width: "12px", color: "textSubtle", style: { cursor: "pointer", marginTop:"10px" } };
...
var WalletCard = function (_a) {
    ...
    return (React.createElement(Button, { width: "100%", variant: "tertiary", onClick: function () {
            ...
            onDismiss();
        }, style: { justifyContent: "space-between",border: "1px solid rgb(134, 133, 133)" }, mb: mb, id: "wallet-connect-" + title.toLocaleLowerCase() },
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true },
            React.createElement(Icon$12, { color: "primary", mr: "6px" }),
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React.createElement(Icon$14, { width: "20px", color: "primary", ml: "4px" }),
...
var Avatar = function (_a) {
    ...
    var icon = image ? (React.createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" })) : (React.createElement(Icon$Q, { width: "32px", height: "32px" }));
    if (isExternal) {
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { textSubtlenew:"#868585",textwhitebl:"#000", panelbg:"#ffffffba", navbg:"#f9f9f9d9", textpurp:"#868585",colrblk:"#868585",color_balck:"#333",color_blue:"#000",primaryblack:"#333",textblack:"#ccc",orange_color:"#f3841e",orangetext_subhead:"#333",dash_heading:"#333",background: "#f9f9f9", textblack:"#333", backgroundDisabled: "#e9eaeb", contrast: "#333", invertedContrast: "#FFFFFF", input: "#e9eaeb", inputSecondary: "#e9eaeb", tertiary: "#f1f1f1", text: "#333", textDisabled: "#868585", textSubtle: "#000", borderColor: "#E9EAEB", card: "#fff",  card_small: "#333", gradients: {
    bubblegum: "linear-gradient(139.73deg, #fff 0%, #fff 100%)",
} });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { textSubtlenew:"#868585",textwhitebl:"#fff",panelbg:"#000000bf", navbg:"#131212ad", textpurp:"#868585",colrblk:"#868585",color_balck:"#fff",color_blue:"#fff",primaryblack:"#fff",textblack:"#fff",orange_color:"#f3841e", orangetext_subhead:"#fff",dash_heading:"#fff",secondary: "#fff", textblack:"#fff", background: "#131212", backgroundDisabled: "#fff", contrast: "#FFFFFF", invertedContrast: "#1a1919", input: "#353535", inputSecondary: "#1a1919", primaryDark: "#0098A1", tertiary: "#1a1919", text: "#fff", textDisabled: "#868585",  card_small: "#fff",textSubtle: "#fff", borderColor: "#49484829", card: "#1a1919", new: "#ffffff", gradients: {
    bubblegum: "linear-gradient(139.73deg, rgb(12 12 12/50%) 0%, rgb(12 12 12/50%) 100%)",
} });
// var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#fff3cd", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#fff3cd", inputSecondary: "#d7caec", tertiary: "#fff3cd", text: "#ff841a", textDisabled: "#002f44", textSubtle: "#ff841a", borderColor: "#E9EAEB", card: "#FFFFFF",  card_small: "#bd8a3e", gradients: {
//     bubblegum: "linear-gradient(139.73deg, #fff3cd 0%, #fff3cd 100%)",
// } });
// var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#19191c", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#323232", inputSecondary: "#66578D", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#ccc", textSubtle: "#ff841a", borderColor: "#524B63", card: "#27262c", gradients: {
//     bubblegum: "linear-gradient(139.73deg, rgb(12 12 12/50%) 0%, rgb(12 12 12/50%) 100%)",
// } });
...
export { Icon$1r as AddIcon, Alert, Icon$1q as ArrowBackIcon, Icon$1p as ArrowDownIcon, Icon$1o as ArrowDropDownIcon, Icon$1n as ArrowDropUpIcon, Icon$1m as ArrowForwardIcon, Icon$1l as ArrowUpIcon, Icon$1k as AutoRenewIcon, BackgroundImage, BalanceInput, GridLayout$1 as BaseLayout, Icon$1j as BinanceIcon, Icon$1t as BlockIcon, Box, Breadcrumbs, Icon$1i as BunnyPlaceholderIcon, Button, ButtonMenu$1 as ButtonMenu, ButtonMenuItem, Icon$1f as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$1g as CardViewIcon, Icon$1h as Cards, GridLayout as CardsLayout, Icon$1d as ChartIcon, Checkbox, Icon$1v as CheckmarkCircleIcon, Icon$1c as CheckmarkIcon, Icon$1b as ChevronDownIcon, Icon$1a as ChevronLeftIcon, Icon$19 as ChevronRightIcon, Icon$18 as ChevronUpIcon, Icon$1e as CircleOutlineIcon, Icon$17 as CloseIcon, Icon$16 as CogIcon, Icon$15 as CommunityIcon, ConnectorNames, Icon$14 as CopyIcon, Icon$13 as CrownIcon, Dropdown, Icon$1u as ErrorIcon, ExpandableButton, ExpandableLabel, FallingBunnies, Flex, Heading, Icon$12 as HelpIcon, Icon$11 as HistoryIcon, IconButton, Image, Icon$1s as InfoIcon, Input$1 as Input, Icon$10 as LaurelLeftIcon, Icon$$ as LaurelRightIcon, Link, LinkExternal, Icon$_ as ListViewIcon, Icon$Z as LogoIcon, Icon$Y as LogoRoundIcon, Icon$X as MedalBronzeIcon, Icon$W as MedalGoldIcon, Icon$V as MedalPurpleIcon, Icon$U as MedalSilverIcon, Icon$T as MedalTealIcon, Menu, Icon$S as MetamaskIcon, Icon$R as MinusIcon, Modal, ModalBackButton, ModalBody, ModalCloseButton, ModalContainer, ModalHeader, ModalProvider, ModalTitle, Icon$Q as NoProfileAvatarIcon, NotificationDot, Icon$P as OpenNewIcon, Icon$N as PancakeRoundIcon, Icon$O as PancakesIcon, Icon$L as PlayCircleOutlineIcon, Icon$M as PocketWatchIcon, Icon$K as PrizeIcon, Progress, Icon$H as ProgressBunny, Radio, Icon$s as RefreshIcon, Icon$J as RemoveIcon, ResetCSS, Icon$y as SearchIcon, Skeleton, Slider, Spinner, Svg, Icon$x as SwapVertIcon, Icon$w as SyncAltIcon, Tab, ButtonMenu as TabMenu, Tag, Icon$E as TeamPlayerIcon, Icon$D as TestnetIcon, Text, Icon$C as Ticket, Icon$B as TicketRound, Icon$A as TimerIcon, ToastContainer, Toggle, Icon$z as TrophyGoldIcon, Icon$I as VerifiedIcon, Icon$v as VolumeOffIcon, Icon$u as VolumeUpIcon, Icon$G as WaitIcon, Icon$t as WarningIcon, Icon$F as Won, variants$2 as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, status as menuStatus, types as toastTypes, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
