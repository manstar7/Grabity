...
class PoolAddModal extends React.Component {
    ...
    addPool= async (e) => {
        ...
        const masterchef = "0x0d4BE57064599EAFEF2DB70B6640e14dA9A6AF2a";
         ...
         console.log("lpAddresses>>>",lpAddress);
    ...
    onPoolAdd = e => {
        ...
        this.props.addPool(newPool, this.props.history);
       // $('#add-pool-modal').modal('hide');
                    ...
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <form noValidate onSubmit={this.onPoolAdd} id="add-pool">
                            ...
                            <div className="modal-footer">
                                ...
                                <button
                                    form="add-pool"
                                    type="submit"
                                    className="btn btn-primary" onClick={this.addPool}>
                                    Add Pool
                                </button>
                            </div>
                        </div>
